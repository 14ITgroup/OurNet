<%@ Page Title="2014级成员" Language="C#" MasterPageFile="~/Itshow.master" AutoEventWireup="true" CodeFile="person2014.aspx.cs" Inherits="person2014" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
         <style>
        .main>img+p{
            background: url(images/cao13.png) no-repeat;
        }
        .main>a+p{
            background: url(images/cao15.png) no-repeat;
        }
     </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="main">
        ...
        <img src="./images/team14.png" alt=""/>
        <a href="person2013.aspx"><img src="./images/Team_buttonl.png" alt=""/></a>
    ...
    <div class="main-mobile">
        ...
        <div>
            ...
            <ul class="hide-per" id="b">
                ...
                <li><a href="person2013.aspx">2013</a></li>
                <li><a href="#">2014</a></li>
            </ul>
        </div>
